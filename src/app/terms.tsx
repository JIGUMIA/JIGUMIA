    ...
    <SafeAreaView edges={['top']} style={{ flex: 1, backgroundColor: colors.background }}>
      ...
      >
        ...
        <Section title="제2조 (정의)" colors={colors}>
          {`1. "서비스"란 회사가 제공하는 브랜드 세일 일정 조회, 관심 브랜드 저장, 알림 기능 등을 말합니다.
...
3. 변경된 약관에 동의하지 않는 회원은 서비스 이용을 중단하고 탈퇴할 수 있습니다.`}
        ...
        <Section title="제4조 (서비스 이용 계약)" colors={colors}>
          {`1. 이용 계약은 회원이 본 약관에 동의하고 Google 또는 Apple 계정을 통해 로그인함으로써 성립됩니다.
2. 회사는 다음 각 호에 해당하는 경우 이용 신청을 거절할 수 있습니다.
  - 타인의 정보를 이용한 경우
  - 서비스 운영을 고의로 방해한 이력이 있는 경우`}
        </Section>

        <Section title="제5조 (서비스의 제공 및 변경)" colors={colors}>
...
2. 서비스 내용은 회사 사정에 따라 변경될 수 있으며, 변경 시 사전 공지합니다.`}
        ...
        <Section title="제6조 (서비스의 중단)" colors={colors}>
...
2. 서비스 중단 시 사전에 공지하며, 불가피한 경우 사후에 공지할 수 있습니다.`}
        ...
        <Section title="제7조 (회원의 의무)" colors={colors}>
...
2. 회원은 본 약관 및 관계 법령을 준수하여야 합니다.`}
        ...
        <Section title="제8조 (회사의 의무)" colors={colors}>
...
3. 회사는 서비스 관련 설비를 항상 운용 가능한 상태로 유지하며, 장애 발생 시 신속히 복구합니다.`}
        ...
        <Section title="제9조 (지적재산권)" colors={colors}>
          서비스에 포함된 콘텐츠(세일 정보, 브랜드 로고, 디자인 등)에 대한 저작권 및 지적재산권은 회사 또는 해당 권리자에게 귀속됩니다. 회원은 서비스를 통해 얻은 정보를 회사의 사전 승인 없이 상업적으로 이용할 수 없습니다.
        </Section>

        <Section title="제10조 (면책 조항)" colors={colors}>
          {`1. 회사는 세일 정보의 정확성을 보장하지 않으며, 각 브랜드의 세일 내용은 해당 브랜드의 공식 채널에서 확인하시기 바랍니다.
2. 회사는 회원이 서비스를 통해 기대하는 수익이나 이익을 보장하지 않습니다.
3. 천재지변 또는 이에 준하는 불가항력으로 인한 서비스 중단에 대해 책임을 지지 않습니다.`}
        </Section>

        <Section title="제11조 (회원 탈퇴 및 자격 상실)" colors={colors}>
          {`1. 회원은 언제든지 서비스 내 "회원 탈퇴" 기능을 통해 탈퇴할 수 있습니다.
2. 탈퇴 시 회원의 관심 브랜드, 알림 설정 등 모든 데이터는 즉시 삭제되며 복구할 수 없습니다.`}
        </Section>

        <Section title="제12조 (분쟁 해결)" colors={colors}>
